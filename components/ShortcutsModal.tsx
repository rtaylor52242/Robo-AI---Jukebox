    ...
    <div className="flex items-center space-x-1">
      {keys.map((key, index) => (
        <React.Fragment key={key}>
          <kbd className="px-2 py-1 text-sm font-semibold text-[var(--accent-primary)] bg-[var(--bg-tertiary)] border border-[var(--border-primary)] rounded-md">
            {key}
          </kbd>
    ...
    <div className="fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center z-50 p-4" onClick={onClose}>
      <div className="bg-[var(--bg-popover)] rounded-xl shadow-2xl shadow-[var(--shadow-color)] border border-[var(--border-primary)] w-full max-w-lg flex flex-col" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="p-6 overflow-y-auto max-h-[70vh] space-y-6">
          <div>
            <h3 className="text-lg font-semibold text-[var(--accent-primary)] mb-2">Playback Controls</h3>
          ...
          <div>
            <h3 className="text-lg font-semibold text-[var(--accent-primary)] mb-2">Navigation</h3>
          ...
          <div>
            <h3 className="text-lg font-semibold text-[var(--accent-primary)] mb-2">Volume</h3>
