      ...
      <div className="bg-[var(--bg-popover)] rounded-xl shadow-2xl shadow-[var(--shadow-color)] border border-[var(--border-primary)] w-full max-w-2xl max-h-[85vh] flex flex-col" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="p-6 overflow-y-auto divide-y divide-[var(--border-primary)]">
            <HelpSection title="Getting Started">
                <p>Click the <strong>"Select Music Folder"</strong> button to load your local audio files. All supported audio files from the selected folder will be added to your library.</p>
            </HelpSection>
            ...
            <HelpSection title="Playlist Management">
                <p>The sidebar on the left organizes your music. You can view all tracks, see your liked songs, and filter by star rating.</p>
                <p>Create your own custom playlists by clicking <strong>"New Playlist"</strong>. To add a song to a playlist, hover over it in the main list and click the <strong className="text-[var(--accent-primary)]">+</strong> icon.</p>
                <p>You can re-order songs within a playlist by dragging and dropping them.</p>
            </HelpSection>
            <HelpSection title="Track Interactions">
                <p>Hover over any track to reveal a set of icons:</p>
            ...
            <HelpSection title="Advanced Tools">
             ...
             <HelpSection title="Keyboard Shortcuts">
                <p>Click the keyboard icon in the header to see a full list of keyboard shortcuts for controlling playback with your number pad.</p>
            </HelpSection>
        </div>
      </div>
    </div>
